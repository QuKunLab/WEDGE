For raw Guo¡¯s dataset [42], you can obtain the scRNA-seq data of the PBMCs from 2 severe COVID-19 patients from the Gene Expression Comprehensive (GEO) database (GSE150861), and download a scRNA-seq data of PBMCs from 2 healthy donors from https://support.10xgenomics.com/single-cell-gene-expression/datasets/3.1.0/5k_pbmc_NGSC3_aggr.
. Then, you can filter genes and cells, the same method as Guo et al [43], to obtain an expression matrix with 23,324 genes and 68,190 cells.
